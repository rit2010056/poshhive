class CreditCardsController < ApplicationController
  ...
  private
    ...
    def credit_card_params
      params.require(:credit_card).permit(:bank, :card_name, :desciption, :travel_reward, :shopping_reward, :joining_fee, :annual_fee, :cashback_reward,:fuel_reward,:is_lifestyle)
    end
end
